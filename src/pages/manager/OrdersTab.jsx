...
export default function OrdersTab({ orders, restaurant, tables, staffList }) {
  ...
  // closeOrder computes this same breakdown server-side but doesn't persist
  // it on the order doc — mirroring the formula here is cheaper than adding
  // a backend field just for history display.
  function bill(order) {
